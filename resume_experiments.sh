...
python3 src/evaluate.py --checkpoint checkpoints/model_test_spec_x_ep50.pth --dataset_mode spectrogram --num_samples 16 --output_dir results/test_spec_x
...
python3 src/evaluate.py --checkpoint checkpoints/model_main_raw_x_ep50.pth --dataset_mode raw --num_samples 16 --output_dir results/main_raw_x
