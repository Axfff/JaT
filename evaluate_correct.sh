...
# Evaluation with correct prediction modes

echo "Evaluating Experiment 1: Control (Spectrogram | Epsilon)"
python3 src/evaluate.py --checkpoint checkpoints/model_control_spec_eps_ep50.pth --dataset_mode spectrogram --num_samples 16 --output_dir results/control_spec_eps --pred_mode epsilon
...
python3 src/evaluate.py --checkpoint checkpoints/model_baseline_raw_eps_ep50.pth --dataset_mode raw --num_samples 16 --output_dir results/baseline_raw_eps --pred_mode epsilon
